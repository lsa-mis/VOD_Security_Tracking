...
RSpec.describe "sensitive_data_systems/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit sensitive_data_system form" do
    render

    assert_select "form[action=?][method=?]", sensitive_data_system_path(@sensitive_data_system), "post" do
