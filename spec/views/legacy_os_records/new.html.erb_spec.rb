...
RSpec.describe "legacy_os_records/new", type: :view do
  before(:each) do
    assign(:legacy_os_record, LegacyOsRecord.new(
  ...
  it "renders new legacy_os_record form" do
    render

    assert_select "form[action=?][method=?]", legacy_os_records_path, "post" do
